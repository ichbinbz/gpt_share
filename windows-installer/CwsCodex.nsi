...
OutFile "${PROJECT_ROOT}${PROJECT_SEP}dist${PROJECT_SEP}CWS-Codex-Setup-v0.1.6.exe"
...
VIAddVersionKey /LANG=2052 "FileVersion" "0.1.6"
VIAddVersionKey /LANG=2052 "ProductVersion" "0.1.6"
...
Section "安装 CWS Codex" MainSection
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\CWS Codex" "DisplayVersion" "0.1.6"
