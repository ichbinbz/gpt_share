...
OutFile "${PROJECT_ROOT}${PROJECT_SEP}dist${PROJECT_SEP}CWS-Codex-Setup-v0.1.7.exe"
...
VIAddVersionKey /LANG=2052 "FileVersion" "0.1.7"
VIAddVersionKey /LANG=2052 "ProductVersion" "0.1.7"
...
Section "安装 CWS Codex" MainSection
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\CWS Codex" "DisplayVersion" "0.1.7"
