...
> [!IMPORTANT]
> This branch restores the core Plus-sharing path by connecting CWS to a real,
> user-authenticated Chromium session over CDP. See the Chinese deployment guide:
> [ChatGPT Plus browser transport](BROWSER_TRANSPORT.zh-CN.md).
