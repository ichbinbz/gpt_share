enum ApiUrl {
  ...
  SystemOpenaiWebBrowserPool = '/system/openai-web-browser-pool',
  SystemCodexAccountQuotas = '/system/codex-account-quotas',
  SystemCodexDeviceUsage = '/system/codex-device-usage',
