...
export interface paths {
  ...
  "/system/check-openai-web-browser": {
    /**
     * Check Openai Web Browser
     * @description Report whether the configured CDP browser and ChatGPT login are ready.
     */
    get: operations["check_openai_web_browser_system_check_openai_web_browser_get"];
  };
  "/system/openai-web-browser-pool": {
    /**
     * Get Openai Web Browser Pool
     * @description Return live health, load and quota estimates for every browser account.
     */
    get: operations["get_openai_web_browser_pool_system_openai_web_browser_pool_get"];
  };
  "/logs/server": {
    /** Get Server Logs */
  ...
  "/arkose/p/{path}": {
     ...
     * @description TODO：/fc/a/?callback=
     */
    get: operations["forward_arkose_request_arkose_p__path__get"];
    /**
     * Forward Arkose Request
     * @description TODO：/fc/a/?callback=
     */
    post: operations["forward_arkose_request_arkose_p__path__get"];
  };
  "/arkose/info": {
    /** Get Arkose Info */
...
export interface components {
  schemas: {
    ...
    "ConfigModel-Input": {
       ...
       *   "browser_poll_interval_ms": 250,
       *   "browser_stable_seconds": 1.5,
    ...
    /** OpenaiWebBrowserAccountSetting */
    OpenaiWebBrowserAccountSetting: {
      /** Id */
      id: string;
      /** Name */
    ...
    OpenaiWebChatGPTSetting: {
       ...
       */
      browser_chatgpt_url?: string;
      /**
       * Browser Poll Interval Ms
       * @default 250
       */
      browser_poll_interval_ms?: number;
      /**
       * Browser Stable Seconds
       * @default 1.5
       */
      browser_stable_seconds?: number;
      /**
       ...
       * @default []
       */
      browser_accounts?: components["schemas"]["OpenaiWebBrowserAccountSetting"][];
      /** Proxy */
      proxy?: string | null;
      /** Wss Proxy */
     ...
     * @enum {string}
     */
    OpenaiWebChatModels: "chatgpt_auto" | "chatgpt_instant" | "chatgpt_thinking" | "chatgpt_pro" | "gpt_3_5" | "gpt_3_5_mobile" | "gpt_4" | "gpt_4o" | "gpt_4_mobile" | "gpt_4_browsing" | "gpt_4_code_interpreter" | "gpt_4_plugins" | "gpt_4_dalle";
    /**
     * OpenaiWebChatStatus
     * @enum {string}
     */
...
export interface operations {
   ...
   * @description Report whether the configured CDP browser and ChatGPT login are ready.
   */
  check_openai_web_browser_system_check_openai_web_browser_get: {
    responses: {
      /** @description Successful Response */
      200: {
        content: {
   ...
   * @description Return live health, load and quota estimates for every browser account.
   */
  get_openai_web_browser_pool_system_openai_web_browser_pool_get: {
    parameters: {
      query?: {
        refresh?: boolean;
        refresh_quota?: boolean;
      };
    };
    responses: {
      /** @description Successful Response */
   ...
   * @description TODO：/fc/a/?callback=
   */
  forward_arkose_request_arkose_p__path__get: {
    parameters: {
      path: {
        path: string;
      };
