...
def create_config(args):
    ...
    if args.browser_cdp_url:
        config.openai_web.browser_cdp_url = args.browser_cdp_url
...
def main():
    ...
    create_config_parser.add_argument('--browser-cdp-url', '-B', type=str,
                                      help='Chromium CDP endpoint used by browser transport.')
