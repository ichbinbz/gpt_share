CWS Codex Ubuntu/Linux 员工端 v0.1.7
=====================================
...
安装：
1. 解压 CWS-Codex-Linux-v0.1.7.tar.gz。
...
- 启动时每天最多检查一次更新：优先从 Broker 获取经设备令牌鉴权的发布清单，Broker 不可用时回退到 GitHub Release。安装了 zenity 时会显示可点击的更新提示；确认后会校验安装包大小和 SHA-256，再自动升级并保留设备令牌和配置。
